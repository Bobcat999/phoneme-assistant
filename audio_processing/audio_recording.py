...
import numpy as np
import wave
from audio_processing.grapheme_to_phoneme import grapheme_to_phoneme
from audio_processing.process_audio import process_audio_array
...
def record_and_process_pronunciation(text, extraction_model):
    ...
    return output[0], ground_truth_phonemes
